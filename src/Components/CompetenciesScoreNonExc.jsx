...
//   // Get the request token from the AuthContext
...
//         // Check if required data exists in local storage
//         if (!serviceNo || !year) {
...
//       }
//     };
//     // Refresh every 3 seconds if local storage data is valid
    // const interval = setInterval(fetchAttendanceSummary, 3000);
...
//                   style={{ backgroundColor: "#fdf2e9" }} r
//                 >
//                   {item.plan}
//                 </td>
...
//                       <td className="border px-4 py-2 text-center">24</td> {/* Replace with dynamic total */}
...
//                       {/* <td className="border px-4 py-2 text-center">{extraHours}</td> */}
//                       <td className="border px-4 py-2 text-center">
